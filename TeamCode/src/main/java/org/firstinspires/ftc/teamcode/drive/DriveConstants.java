...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = (double) 1 / 20; // output (wheel) speed / input (motor) speed, ex 40:1 -> 1/40
    ...
    public static double kA = 0.0000005;
    ...
    public static double MAX_ANG_VEL = 3.1165037155151367;
    public static double MAX_ANG_ACCEL = 2.4932029724121096;
